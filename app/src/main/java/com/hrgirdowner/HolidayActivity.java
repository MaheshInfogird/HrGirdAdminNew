...
public class HolidayActivity extends BaseActivityExp {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            ...
            Header.setText("Holidays");
            getSupportActionBar().setDisplayShowTitleEnabled(false);
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        }

        shared_pref = this.getSharedPreferences(MyPREFERENCES_url, PRIVATE_MODE);
        Url = (shared_pref.getString("url", ""));
        //Log.i("Url", Url);

        mSwipeRefreshLayout = (SwipeRefreshLayout) this.findViewById(R.id.refresh_layout_holiday_act);
        layout_Progress = (LinearLayout)this.findViewById(R.id.holiday_Progress_act);
        layout_addHoliday = (LinearLayout)this.findViewById(R.id.layout_addHoliday_act);
        holiday_list = (ListView)this.findViewById(R.id.holidays_list_act);
        ac_holidays_month = (AutoCompleteTextView)this.findViewById(R.id.ac_holiday_month_act);
        txt_no_holidays = (TextView)this.findViewById(R.id.txt_no_holidays_act);
        layout_edit_delete = (LinearLayout)this.findViewById(R.id.edit_delete_layout_act);
        txt_holidayCount = (TextView)this.findViewById(R.id.holiday_count_act);
        snackbarCoordinatorLayout = (CoordinatorLayout)this.findViewById(R.id.snackbarCoordinatorLayout_act);
     ...
     /*   ac_holidays_month.setOnClickListener(new View.OnClickListener() {
        ...
        receiver = new NetworkChange()
        {
            ...
            protected void onNetworkChange()
            {
                ...
                {
                    hit_once = true;
                    Toast.makeText(HolidayActivity.this, "No internet connection", Toast.LENGTH_LONG).show();
       ...
       /* ac_holidays_month.setOnItemClickListener(new AdapterView.OnItemClickListener() {
        ...
        layout_addHoliday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HolidayActivity.this, AddNewHoliday.class);
        ...
        if (internetConnection.hasConnection(this)) {
            ...
            internetConnection.showNetDisabledAlertToUser(this);
        }
                ...
                if (result != null)
                {
                    ...
                    try
                    {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++)
                        {
                            ...
                            final ArrayAdapter<String> adapter = new ArrayAdapter<String>(HolidayActivity.this, R.layout.year_drop_down, year_array);
                    ...
                    Toast.makeText(HolidayActivity.this, "Sorry...Bad internet connection", Toast.LENGTH_LONG).show();
                }
            }
        }
            ...
            protected void onPostExecute(String result)
            {
                if (result != null) 
                {
                    ...
                    try
                    {
                        ...
                        adapter = new ArrayAdapter<String>(this, R.layout.dropdown_custom, year_array);
                        ac_holidays_month.setAdapter(adapter);
                    } 
                    catch (JSONException e) {
                        Log.e("JsonException", e.toString());
                    ...
                    Toast.makeText(this, "Sorry...Bad internet connection", Toast.LENGTH_LONG).show();
                }
            }
        }
            ...
            protected void onPreExecute() {
                if (!refresh)
                {
                    if (date_select) {
                        ...
                        progressDialog = ProgressDialog.show(HolidayActivity.this, "Please Wait", "Getting data...", true);
                        progressDialog.show();
                    }
                }
            }
            ...
            protected void onPostExecute(String result)
            {
                ...
                if (result != null)
                {
                    ...
                    try
                    {
                        ...
                        if (count == 1) {
                            String holiday_count = String.valueOf(count) + " Holiday in this Year";
                            txt_holidayCount.setText(holiday_count);
                        }
                        else if (count >= 2) {
                            String holiday_count = String.valueOf(count) + " Holidays in this Year";
                            txt_holidayCount.setText(holiday_count);
                        }

                        if (myJson.equals("[]"))
                        {
                            txt_holidayCount.setText("No Holiday in this Year");
                        ...
                        else
                        {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++)
                            {
                                ...
                                adapter1 = new holidayList(HolidayActivity.this, array_list, R.layout.leave_holidays_custom, new String[]{}, new int[]{});
