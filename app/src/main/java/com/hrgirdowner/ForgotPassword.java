...
public class ForgotPassword extends AppCompatActivity {
    ...
    String myJson, myJson1, myJson2, response_mail, response_pass;
    ...
    public void sendMailMobData()
    {
        class GetLogoData extends AsyncTask<String, Void, String>
        {
            ...
            protected void onPreExecute() {
                progressDialog = ProgressDialog.show(ForgotPassword.this, "Please wait", "Checking info...", true);
                progressDialog.show();
            }
    ...
    public void resetPassword()
    {
        class GetLogoData extends AsyncTask<String, Void, String>
        {
            @Override
            protected void onPreExecute() {
                progressDialog2 = ProgressDialog.show(ForgotPassword.this, "Please wait", "Resetting password...", true);
