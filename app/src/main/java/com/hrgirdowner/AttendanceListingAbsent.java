...
public class AttendanceListingAbsent  extends BaseActivityExp {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendance_listing_absent);
        ...
        if (getSupportActionBar() != null) {
            ...
            Header.setText("Absent");
            getSupportActionBar().setDisplayShowTitleEnabled(false);
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        }

        content_frame = (FrameLayout) findViewById(R.id.content_frame_attList_absent);
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.refresh_layout_att_list_absent);
        layout_progress = (LinearLayout)findViewById(R.id.att_list_Progress_absent);
        ac_attDate = (TextView)findViewById(R.id.att_list_txtDate_absent);
        attList_list = (ListView)findViewById(R.id.att_listing_absent);
        layout_attList_date = (LinearLayout)findViewById(R.id.att_list_date_absent);
        txt_no_data = (TextView)findViewById(R.id.txt_no_attList_data_absent);
        ed_search = (EditText)findViewById(R.id.att_list_edSearch_absent);
        ...
        layout_attList_date.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                DatePickerDialog dpd = new DatePickerDialog(AttendanceListingAbsent.this, new DatePickerDialog.OnDateSetListener()
                {
                    @Override
        ...
        if (internetConnection.hasConnection(getApplicationContext()))
        {
            ...
            internetConnection.showNetDisabledAlertToUser(AttendanceListingAbsent.this);
        }
    }
...
//                        get_set.setWorkHour(object.getString(TAG_WorkHrs));
                ...
                adapter = new attListAdapter(AttendanceListingAbsent.this, array_list1);
        ...
        class GetAttListingData extends AsyncTask<String, Void, String>
        {
            ...
            protected void onPreExecute() {
                if (!refresh)
                {
                    if (date_select)
                    {
                        ...
                        progressDialog = ProgressDialog.show(AttendanceListingAbsent.this, "Please wait", "Getting data...", true);
                        progressDialog.show();
                    }
                }
            }
            ...
            protected String doInBackground(String... params)
            {
                try
                {
                   // https://infogird.hrgird.com/owner/hrmapi/dailyempabsentleaveReport/?date=2017-04-25&datafor=1
                    ...
                    String query3 = String.format("date=%s&datafor=%s", URLEncoder.encode(current_date, "UTF-8"),URLEncoder.encode("1", "UTF-8"));
            ...
            protected void onPostExecute(String result)
            {
                ...
                if (result != null)
                {
                    ...
                    Toast.makeText(AttendanceListingAbsent.this, "Sorry...Bad internet connection", Toast.LENGTH_LONG).show();
                }
            }
        }
    ...
    public class attListAdapter extends BaseAdapter
    {
        ...
        public View getView(int position, final View convertView, ViewGroup parent)
        {
          ...
          //  final TextView txt_cid      = (TextView)vi.findViewById(R.id.att_list_cid_absent);
            ...
            layout_status.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    if (current_stat.equals("A")){
                        Toast.makeText(AttendanceListingAbsent.this, "Absent", Toast.LENGTH_SHORT).show();
                    }
...
*/
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(AttendanceListingAbsent.this, DashBoard.class);
